...
class Eoptimization:
    ...
    def __init__(self, config = ""):
        ...
        if self.influxconfig['influxdb_version'] == 1:
            ...
            self.influxclient = InfluxDBClient(url=self.influxconfig['influxdb_ip'], port=self.influxconfig['influxdb_port'], token=self.influxconfig['influxdb_token'], org=self.influxconfig['influxdb_organization'])
